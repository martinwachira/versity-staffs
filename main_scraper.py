...
for row in records.itertuples(index=False):
    serverId, name, institution, organization = getattr(row, 'serverId'), getattr(row, 'name'), getattr(row, 'company'), getattr(row, 'Organization')
    ...
    #     EMAILS.append((serverId, name, institution, organization, email))
    #
...
df  = pd.DataFrame(EMAILS, columns=['serverId','name', 'institution', 'organization', 'email'])
df.to_csv('data.csv')
